...
const translations = {
  "en": {
    ...
    "cv_text": "For more information, you can consult my most recent <a href='documents/CV.pdf' target='_blank'>CV</a>.<br>(Last CV update: 04/14/2026)"
  },
  "fr": {
    "page_title": "Baptiste's Dashboard",
    ...
    "cv_text": "Pour plus d'informations vous pouvez consulter mon <a href='documents/CV.pdf' target='_blank'>CV</a> le plus récent.<br>(Dernière mise à jour du CV : 14/04/2026)"
  }
};
